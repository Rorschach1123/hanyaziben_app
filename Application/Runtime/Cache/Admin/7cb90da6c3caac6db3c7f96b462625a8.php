...
<div class="pd-20">
  <div class="text-c">
  <form class="Huiform" action="<?php echo U('Admin/Adviser/real');?>" method="get">
  <select class="input-small" id="DropDownTimezone" name="n">
    ...
    <input type="text" name="k" id="" value="<?php echo ($k); ?>" placeholder="请输入顾问账号" style="width:250px;text-align:center" class="input-text"><button name="" id="" class="btn btn-success" type="submit"><i class="icon-search"></i>搜索</button>
  </div>
  </form>
