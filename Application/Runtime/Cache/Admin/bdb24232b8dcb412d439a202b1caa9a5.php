...
<body>
<header class="Hui-header cl"> <a class="Hui-logo l" title="掌上瀚亚后台管理系统&nbsp;&nbsp;V1.0.3" href='/hanyaziben_app/index.php/Index' target="_top">掌上瀚亚后台管理系统</a><span class="Hui-subtitle l">V1.0.3</span> <span class="Hui-userbox"><span class="c-white">当前管理员:<?php echo (session('name')); ?></span> <a class="btn btn-danger radius ml-10" href="<?php echo U('Admin/login/loginout');?>" title="退出" target="_top"><i class="icon-off"></i> 退出</a></span></header>
